  ...
  <ArrowLeft className="w-5 h-5 text-gray-400 rotate-180" />
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-medium text-gray-900">포인트 상점</span>
                <span className="px-2 py-0.5 bg-purple-100 text-purple-700 text-[10px] font-bold rounded-full">{profile?.points || 0}P</span>
              </div>
              <ArrowLeft className="w-5 h-5 text-gray-400 rotate-180" />
            </button>
